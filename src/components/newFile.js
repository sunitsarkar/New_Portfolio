        ...
        <div style={{
          ...
          >
            <div style={{ display:"flex", justifyContent:"space-between", flexWrap:"wrap", gap:8, marginBottom:12 }}>
              <h3 style={{ fontSize:20, fontWeight:700 }}>Apprentice Engineer</h3>
              <span style={{ fontFamily:"var(--font-mono)", color:"var(--accent)", fontSize:12 }}>Aug 2021 – Sep 2021</span>
            </div>
            <p style={{ color:"var(--accent)", fontFamily:"var(--font-mono)", fontSize:13, marginBottom:16 }}>The Durgapur Projects Limited</p>
            <ul style={{ listStyle:"none", paddingLeft:0, display:"flex", flexDirection:"column", gap:10 }}>
              {[
                "Gained hands-on exposure to Heat Engine operation and thermodynamic principles.",
                "Observed industrial Turbine systems and their integration in power generation.",
                "Studied Generator design, working mechanisms, and electrical output management.",
                "Collaborated with senior engineers on live plant floor diagnostics.",
              ].map((item, i) => (
                <li key={i} style={{ display:"flex", gap:12, color:"#8a9ab5", fontSize:14, lineHeight:1.7 }}>
